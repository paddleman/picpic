defmodule PicpicWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="space-y-8 bg-white bg-opacity-5 mt-10 p-4">
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-mc-dark-teal hover:bg-mc-med-teal py-2 px-3",
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <label phx-feedback-for={@name} class="flex items-center gap-4 text-sm leading-6 text-zinc-200">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PicpicWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PicpicWeb.Gettext, "errors", msg, opts)
    end
  end
