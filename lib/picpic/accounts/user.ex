defmodule Picpic.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :username, :full_name, :password, :avatar_url, :bio, :background_url])
    |> validate_email(opts)
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Picpic.Repo)
      |> unique_constraint(:username)
    else
      changeset
    end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Picpic.Repo)
  ...
  """
  def valid_password?(%Picpic.Accounts.User{hashed_password: hashed_password}, password)
